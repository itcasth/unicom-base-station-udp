...
import com.doit.net.unicom.udp.bean.UnicomGetParamBean;

/**
 * Created by wiker on 2016/4/14.
 */
public class LTEGetParamHandler implements UnicomHandler {

    @Override
    public void handler(UnicomMessage msg) {

        UnicomGetParamBean bean = new UnicomGetParamBean(msg.messageType,msg.messageCode,msg.messageContent);
